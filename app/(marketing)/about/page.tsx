...
export default function AboutPage() {
  return (
    <div className="flex flex-col">
      {/* Hero Section - Updated to match resources style */}
          ...
          <div className="flex flex-col items-center justify-center space-y-8 text-center">
            <div className="space-y-4">
              ...
              <p className="mx-auto max-w-[700px] text-gray-400 text-base sm:text-lg md:text-xl">
                We&apos;re building the future of lead generation, connecting
                quality advertisers with top media buyers in a transparent,
      ...
      {/* Mission Section - Updated with consistent spacing */}
          ...
          <div className="grid gap-12 md:grid-cols-2 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                quality-focused marketplace that benefits both advertisers and
                media buyers.
              </p>
              <p className="text-muted-foreground">
      ...
      {/* Values Section - Updated with consistent spacing */}
      <section className="py-8 sm:py-12">
        <div className="mx-auto w-full max-w-7xl px-4">
          <div className="space-y-8">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <Card className="p-6">
                ...
                <p className="text-muted-foreground">
                  We maintain strict verification processes and quality controls
                  to ensure the best outcomes for all parties.
                </p>
              </Card>
              <Card className="p-6">
                ...
                <p className="text-muted-foreground">
                  We believe in building long-term relationships that benefit
                  both advertisers and media buyers.
                </p>
              </Card>
              <Card className="p-6">
              ...
              <Card className="p-6">
                ...
                <p className="text-muted-foreground">
                  We continuously improve our platform and processes to drive
                  better results.
                </p>
              </Card>
            </div>
      ...
      {/* Team Section - Updated with consistent spacing */}
      <section className="py-8 sm:py-12">
        <div className="mx-auto w-full max-w-7xl px-4">
